...
Technical documentation and how-to articles for macOS lab management and security.

| Guide | Description |
|-------|-------------|
| [SSH Pubkey Authentication](ssh-pubkey-auth.md) — set up key-based SSH on a single Mac; disable password auth |
